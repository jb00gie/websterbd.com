...
<div class="container">
	...
	<h3 class="brand-primary">Brand Primary</h3>
	<h3 class="brand-success">Brand Success</h3>
	<h3 class="brand-warning">Brand Warning</h3>
	<h3 class="brand-danger">Brand Danger</h3>
	<h3 class="brand-info">Brand Info</h3>
	<h3 class="brand-white">Brand White</h3>
	<h3 class="brand-cream">Brand Cream</h3>
	<h3 class="brand-red">Brand Red</h3>
	<h3 class="brand-blue">Brand Blue</h3>
	<h3 class="brand-black">Brand Black</h3>
	<h3 class="brand-cool-blue">Brand Cool Blue</h3>
